...
namespace NuGet
{
	...
	public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
	{
		...
		public static SemanticVersion Parse(string version)
		{
			...
			{
				throw new ArgumentException("CannotBeNull", "version");
			}

			SemanticVersion semVer;
			if (!TryParse(version, out semVer))
			{
				throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, "InvalidVersion", version), "version");
			}
			return semVer;
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (other == null)
			{
				throw new ArgumentException("NotSemanticVersion", nameof(obj));
			}
